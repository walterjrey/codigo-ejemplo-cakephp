		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr id="header_events_table">
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="#" class="order_link" order_field="email" order_dir="asc">Email/Username</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a href="#" class="order_link" order_field="level" order_dir="asc">Level</a></th>
					<th class="table-header-repeat line-left"><a href="#" class="order_link" order_field="status" order_dir="asc">Status</a></th>
					<th class="table-header-repeat line-left"><a href="#" class="order_link" order_field="created" order_dir="asc">Register Date</a></th>
...
function get_page() {
    ...
    $.ajax({
       type: "POST",
       url: "admin/ajax_get_all_users_page?t="+timestamp,
       data: datos,
       dataType: 'html',
       beforeSend: function(){
...
function event_actions(action, id) { 
    ...
    $.ajax({
       type: "POST",
       url: "admin/ajax_user_actions?t="+timestamp,
       data: datos,
       dataType: 'json',
       beforeSend: function(){
