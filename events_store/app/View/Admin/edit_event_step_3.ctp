...
<tr>
	...
	<tr>
		...
		<td><input type="text" name="max_tickets" class="inp-form" value="<?php echo (!empty($Event)?$Event->data['Event']['max_tickets']:'');?>" /></td>
		<td></td>
	</tr>    
	<tr>
	<th>Sectors:</th>
    ...
    <tr><td colspan="2"><table width="100%">
        <tr>
        	...
        	<td>
            <div class="colorSelector" id="colorPick_<?php echo $key;?>"><div style="background-color: #<?php echo $pricing['Pricing']['hex_color'];?>"></div></div>
            <input type="hidden" name="color[]" class="colorPick" value="<?php echo $pricing['Pricing']['hex_color'];?>" /></td>
        	<td></td>
        </tr>
        <tr>
        	<th valign="top">Sector Name:</th>
        	<td><input type="text" name="sector[]" class="inp-form" value="<?php echo $pricing['Pricing']['sector_name'];?>" /></td>
        	<td></td>
        </tr>
        <tr>
        	<th valign="top">External URL to buy ticket:</th>
        	<td><input type="text" name="url[]" class="inp-form" value="<?php echo $pricing['Pricing']['url'];?>" /></td>
        	<td></td>
        </tr>
        <tr>
        	<th valign="top">Price:</th>
        	<td><input type="text" name="price[]" class="inp-form" value="<?php echo $pricing['Pricing']['price'];?>" /></td>
        	<td></td>
        </tr>
        <tr>
        	<th valign="top">Service Price:</th>
        	<td><input type="text" name="servprice[]" class="inp-form" value="<?php echo $pricing['Pricing']['service_price'];?>" /></td>
        	<td></td>
        </tr>
        <tr>
        	<th valign="top">Stock:</th>
        	<td><input type="text" name="stock[]" class="inp-form" value="<?php echo $pricing['Pricing']['stock'];?>" /></td>
        	<td></td>
        </tr>
        ...
        <script type="text/javascript">
           $(function() {
                $('#colorPick_<?php echo $key;?>').ColorPicker({
            		color: '#<?php echo $pricing['Pricing']['hex_color'];?>',
	...
	<td>
    <?php if(!empty($Event->data['Event']['sectors_image'])):?>
    <img src="Thumbs/show/<?php echo $Event->data['Event']['id'];?>/800/600/<?php echo $Event->data['Event']['sectors_image'];?>/jpg/sectors" />
    <?php else:?>
