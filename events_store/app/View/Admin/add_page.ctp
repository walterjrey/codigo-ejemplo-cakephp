...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" name="orden" class="inp-form" /></td>
			<td></td>
		</tr>        
		<tr>
		<th valign="top">Show in the site<br /> menu:</th>
		<td>	
		<input type="radio" name="show_in_menu" value="1" /> Yes&nbsp;&nbsp;
        <input type="radio" name="show_in_menu" value="2" checked="true" /> No
		</td>
		<td></td>
		</tr> 
		<tr id="menu_where" style="display: none;">
			<th valign="top">Footer/Header:</th>
			<td>
    		<input type="radio" name="show_where" value="1" checked="true" /> Header&nbsp;&nbsp;
            <input type="radio" name="show_where" value="2" /> Footer

            </td>
			<td></td>
		</tr>                   
		<tr id="menu_text" style="display: none;">
			<th valign="top">Menu text:</th>
			<td><input type="text" name="menutext" class="inp-form-large" /></td>
			<td></td>
		</tr> 
		<tr>
		...
		<select  class="styledselect_form_1" name="page_content" id="page_content">
            ...
            <option value="latest_event_list">Latest Events</option>
            <option value="all_events">All Events</option>
			<option value="category_events">Events in Category</option>
            <option value="hot_events">Hot Events</option>
		</select>
		</td>
		<td></td>
		</tr>                                
	<tr id="page_type_content" style="display: none;">
		<th valign="top">Content:</th>
		<td><textarea rows="100" cols="" name="description" class="form-textarea tinymce"></textarea></td>
		<td></td>
	</tr>   
	<tr id="category_content" style="display: none;">
